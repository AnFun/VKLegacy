...
public enum ParticleEffect
{
    ...
    private ParticleEffect(final String name2, final int ordinal, final String name, final int id, final int requiredVersion, final ParticleProperty... properties) {
        this.name = name;
        this.id = id;
    ...
    public enum ParticleProperty
    {
        ...
        private ParticleProperty(final String name, final int ordinal) {
        }
    }
