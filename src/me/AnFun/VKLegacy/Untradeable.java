...
public class Untradeable implements Listener
{
    ...
    public static boolean isItemTradeable(final ItemStack is) {
    ...
    public void onDropItem(final PlayerDropItemEvent e) {
        ...
        if (e.getItemDrop().getItemStack().getItemMeta().hasLore() && e.getItemDrop().getItemStack().getItemMeta().getLore().contains(ChatColor.GRAY + "Permenant Untradeable")) {
            e.setCancelled(true);
        }
    }
    ...
    public void onPickup(final PlayerPickupItemEvent e) {
        ...
        if (e.getItem().getItemStack().getItemMeta().hasLore() && e.getItem().getItemStack().getItemMeta().getLore().contains(ChatColor.GRAY + "Permenant Untradeable")) {
            e.setCancelled(true);
        }
