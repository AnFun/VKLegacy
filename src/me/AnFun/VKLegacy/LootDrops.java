  ...
  public static ItemStack createLootDrop(int tier) {
    ...
    if (dodrop < 50) {
      ...
      if (tier == 2) {
        ...
        potmeta.setLore(Arrays.asList(new String[] { ChatColor.GRAY + "A potion that restores " + ChatColor.GREEN + "75HP" }));
        PotionMeta pm = (PotionMeta)potmeta;
        pm.clearCustomEffects();
        pm.addCustomEffect(PotionEffectType.HEAL.createEffect(0, 0), true);
        pot.setItemMeta((ItemMeta)pm);
      ...
      if (tier == 3) {
        ...
        potmeta.setLore(Arrays.asList(new String[] { ChatColor.GRAY + "A potion that restores " + ChatColor.AQUA + "300HP" }));
        PotionMeta pm = (PotionMeta)potmeta;
        pm.clearCustomEffects();
        pm.addCustomEffect(PotionEffectType.HEAL.createEffect(0, 0), true);
        pot.setItemMeta((ItemMeta)pm);
      ...
      if (tier == 4) {
        ...
        potmeta.setLore(
            Arrays.asList(new String[] { ChatColor.GRAY + "A potion that restores " + ChatColor.LIGHT_PURPLE + "750HP" }));
        PotionMeta pm = (PotionMeta)potmeta;
        pm.clearCustomEffects();
        pm.addCustomEffect(PotionEffectType.HEAL.createEffect(0, 0), true);
        pot.setItemMeta((ItemMeta)pm);
      ...
      if (tier == 5) {
        ...
        potmeta.setLore(
            Arrays.asList(new String[] { ChatColor.GRAY + "A potion that restores " + ChatColor.YELLOW + "1800HP" }));
        PotionMeta pm = (PotionMeta)potmeta;
        pm.clearCustomEffects();
        pm.addCustomEffect(PotionEffectType.HEAL.createEffect(0, 0), true);
        pot.setItemMeta((ItemMeta)pm);
